...
IA / LLM:
  ...
  - Modèle prod: gpt-oss:120b-cloud (via Ollama cloud, CSA+HCA, 1M contexte)
...
class DownloaderPlugin : Plugin<Project> {
    override fun apply(project: Project) {
        ...
        project.tasks.register("collectMusic", DownloadMusicTask::class.java)
...
└─────────────────────────────────────────────────────────────┘
         ...
         ▼
┌─────────────────────────────────────────────────────────────┐
│  collectMusic Task (DownloadMusicTask.kt)                    │
└─────────────────────────────────────────────────────────────┘
         │
         ▼
┌─────────────────────────────────────────────────────────────┐
...
=== Téléchargement
```bash
./gradlew collectMusic --url="URL_YOUTUBE"

./gradlew collectMusic --url="URL" --output="./ma_musique"

./gradlew collectMusic       # Depuis musics.yml
...
- `newpipe-gradle` : `/home/cheroliv/workspace/foundry/newpipe-gradle`
- `mp3-organizer` : `/home/cheroliv/Musique/abdo/mp3-organizer`
- `plantuml-gradle` : `/home/cheroliv/workspace/foundry/plantuml-gradle`
...
4. Exécution : ./gradlew collectMusic --url="..."
```
